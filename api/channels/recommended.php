...
if ($category === '' || $hash !== 'f38e8c02a69ac54996688c8830533') {
...
// Build TGStat URL
$url = sprintf('https://api.tgstat.ru/channels/search?token=%s&category=%s&country=ru&limit=11', urlencode($token), urlencode($category));
