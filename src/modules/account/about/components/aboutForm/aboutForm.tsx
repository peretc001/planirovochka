...
import { addAvatarApi } from '@/modules/account/about/api/addAvatarApi'
import { addProfileApi } from '@/modules/account/about/api/addProfileApi'
import { deleteAvatarApi } from '@/modules/account/about/api/deleteAvatarApi'
