...
import AddFile from '@/modules/account/portfolio/add/components/addFile/addFile'
import AddPhotos from '@/modules/account/portfolio/add/components/addPhotos/addPhotos'
import { addPortfolioApi } from '@/modules/account/portfolio/api/addPortfolioApi'
...
const Add = () => {
  ...
  const { isLoading, mutate: save } = useMutation({
    ...
    onSuccess: () => {
      ...
      router.replace(paths.account.portfolio.index)
    }
  })
