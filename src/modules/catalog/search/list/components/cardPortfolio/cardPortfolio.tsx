...
import CardPortfolioItem from '@/modules/catalog/search/list/components/cardPortfolioItem/cardPortfolioItem'
  ...
  return (
    <div className={styles.root}>
      <div className={styles.header}>
        <h3>
          <Link href={paths.catalog + '/' + slug + '#portfolio'} target="_blank">
        ...
        <Link
          ...
          href={paths.catalog + '/' + slug + '#portfolio'}
          target="_blank"
        >
          {t('view_all')}
        </Link>
