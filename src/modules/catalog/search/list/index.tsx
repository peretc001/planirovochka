...
} from '@/modules/catalog/search/list/api/getProfilesApi'
import Cards from '@/modules/catalog/search/list/components/cards/cards'
import Empty from '@/modules/catalog/search/list/components/empty/empty'
