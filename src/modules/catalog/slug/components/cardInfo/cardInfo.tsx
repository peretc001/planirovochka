...
import CardInfoExperience from '@/modules/catalog/slug/components/cardInfo/cardInfoExperience'
import CardInfoStatus from '@/modules/catalog/slug/components/cardInfo/cardInfoStatus'
